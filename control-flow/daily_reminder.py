...
match priority:
    ...
    case "medium":
        if time_bound == "yes":
            ...
            print(f"Reminder: '{task}' is a medium priority task. You should plan it into your day.")
    case "low":
        if time_bound == "yes":
            print(f"Reminder: '{task}' is a low priority task, but since it's time-bound, don't forget to do it today.")
        else:
